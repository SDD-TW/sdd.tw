        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-6">
              由<a href="https://waterballsa.tw/" target="_blank" rel="noopener noreferrer" className="text-yellow-400 font-bold underline hover:text-yellow-300 transition-all duration-300 hover:brightness-125">水球軟體學院</a>創建的研究組織，專注於在臺推動 SDD（規格驅動開發）來放大百倍軟體產業的經濟規模。
            </p>
        ...
        <div className="border-t border-gray-800 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} 臺灣規格驅動開發. Founded by <a href="https://waterballsa.tw/" target="_blank" rel="noopener noreferrer" className="text-yellow-400 font-bold underline hover:text-yellow-300 transition-all duration-300 hover:brightness-125">水球軟體學院</a>.
            </p>
