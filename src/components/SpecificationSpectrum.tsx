...
...`,
  ...
  },
  {
    ...
    description: [
        { text: <>由「<a href="https://waterballsa.tw/ai-bdd/" target="_blank" rel="noopener noreferrer" className="text-yellow-400 font-bold underline hover:text-yellow-300 transition-all duration-300 hover:brightness-125">水球軟體學院這門課程</a>」中研發的方法論，先定義好「指令集架構」，每個指令對應一項系統操作或驗證，能確保 AI 產出的測試程式碼正確率將近 99%。</>, type: 'advantage' },
