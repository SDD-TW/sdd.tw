        ...
        >
          ...
          <ScrollAnimation type="fadeInUp" delay={0} once={false}>
            ...
            <p className="subheading max-w-4xl mx-auto">
              <a href="https://waterballs.tw/sddtw-index" target="_blank" rel="noopener noreferrer" className="text-[#2ee9ff] font-bold underline hover:text-yellow-300 transition-all duration-300 hover:brightness-125">水球軟體學院</a>所推廣的技術原理，能在「功能性需求」上能做到 100% 正確全自動化開發，而我們認為這種<strong className="text-cyan-400">「高精度」</strong>的規格實踐，才是 SDD 的未來。
            </p>
